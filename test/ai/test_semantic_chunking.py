...
# Ensure backend/service path is available after moving tests
repo_root = Path(__file__).resolve().parent.parent.parent
spec_path = repo_root / "backend" / "ai" / "services" / "semantic_chunker.py"

import importlib.util
spec = importlib.util.spec_from_file_location("semantic_chunker", spec_path)
