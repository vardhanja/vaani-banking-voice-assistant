...
- ✅ **Deep Linking** - Open chat with pre-filled messages
- ✅ **WebView Bridge** - Seamless communication with React frontend
- ✅ **Native iOS Shell** - Better performance and offline support

## 📱 Supported Intents

1. **Check Balance** - "Hey Siri, check my balance"
2. **Transfer Money** - "Hey Siri, transfer money"
3. **View Transactions** - "Hey Siri, show my transactions"
4. **Set Reminder** - "Hey Siri, set a payment reminder"
